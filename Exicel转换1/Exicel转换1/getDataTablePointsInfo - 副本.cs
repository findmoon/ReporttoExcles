...
namespace Exicel转换1
{
    ...
    class getDataTablePointsInfo
    {
        ...
        public int[][] GetInfo_Between(string findString)
        {
            ...
            */
            ...
            {
                this.EndPoint = new int[] { this._dt.Rows.Count,this._dt.Columns.Count};
            }
            if (this.StartPoint[0]==this.EndPoint[0])//同一行
            {
                this.EndPoint = new int[] { this._dt.Rows.Count, this.EndPoint[1] };
            }
            if (this.StartPoint[1] == this.EndPoint[1])//同一列
            {
                this.EndPoint = new int[] { this.EndPoint[0], this._dt.Columns.Count };
            }
